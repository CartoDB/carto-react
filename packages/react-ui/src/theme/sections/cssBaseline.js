...
export const CssBaseline = {
  '@global': {
    ...
    '*::-webkit-scrollbar-thumb': {
      borderRadius: '3px',
      background: themePalette.action.focus,
      outline: 'none'
    },
      ...
      '&.mapboxgl-compact': {
        ...
        '&.mapboxgl-compact-show': {
          '& .mapboxgl-ctrl-attrib-button': {
            ...
            backgroundColor: themePalette.common.black,
