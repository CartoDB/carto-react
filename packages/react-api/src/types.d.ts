...
export declare type Credentials = CredentialsCarto2 | CredentialsCarto3;
export declare type SourceProps = {
    data: string;
...
export declare type UseCartoLayerFilterProps = {
    binary?: boolean;
...
export declare type ExecuteSQLResponse<Response = FeatureCollection | {}[]> = Promise<Response>;
export {};
