import { transformWGS84ToTileCoords } from '../../src/projections/wgs84ToTileCoords';
...
describe('wgs84ToTileCoords', () => {
  test('projects correctly', () => {
    const transformedGeometry = transformWGS84ToTileCoords(
      GEOMETRY_AS_WGS84,
      TILE_2_3_3_BBOX
    );
