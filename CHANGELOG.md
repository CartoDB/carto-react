...
- Add clear button for TimeSeriesWidget widget and enable the speed button even though the animation has not started  [#238](https://github.com/CartoDB/carto-react/pull/239)
